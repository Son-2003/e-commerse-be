package org.ecommersebe.ecommersebe.advice;
...
import org.ecommersebe.ecommersebe.models.payload.error.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ECommerseException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<ErrorDetail> handleFAMSApiException(ECommerseException ex, WebRequest request) {
